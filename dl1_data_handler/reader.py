...
class DLDataReader:
    def __init__(
        ...
        if "CTA INSTRUMENT ID" in self._v_attrs:
            self.instrument_id = self._v_attrs["CTA INSTRUMENT ID"]
        else: 
            self.instrument_id= "LST-1 subarray"
